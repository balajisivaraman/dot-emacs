...
(use-package org
  ...
  (setq
   ...
   org-agenda-prefix-format '((agenda . "  %i   %-12c   %-6e   %-6s %-8(bs/format-entry-scheduled-deadline-time)")
                              (todo . "  %i   %-12c   %-6e   ")
                              (tags . "  %i   %-12c   %-6e   ")
                              (search . "  %i   %-12c   %-6e   "))
   org-agenda-category-icon-alist `(("Account" ,(s-concat bs/org-agenda-icons-path "tw.png") nil nil :ascent center)
                                    ("AcctStrategy" ,(s-concat bs/org-agenda-icons-path "tw.png") nil nil :ascent center)
                                    ("Amma" ,(s-concat bs/org-agenda-icons-path "family.png") nil nil :ascent center)
                                    ("Andromeda" ,(s-concat bs/org-agenda-icons-path "nixos.png") nil nil :ascent center)
                                    ...
                                    ("Finances" ,(s-concat bs/org-agenda-icons-path "ledger.png") nil nil :ascent center)
                                    ("DevModel" ,(s-concat bs/org-agenda-icons-path "tw.png") nil nil :ascent center)
                                    ...
                                    ("HLedgerYNAB" ,(s-concat bs/org-agenda-icons-path "ledger.png") nil nil :ascent center)
                                    ...
                                    ("MilkyWay" ,(s-concat bs/org-agenda-icons-path "nixos.png") nil nil :ascent center)
                                    ("NixOS" ,(s-concat bs/org-agenda-icons-path "nixos.png") nil nil :ascent center)
                                    ...
                                    ("Polaris" ,(s-concat bs/org-agenda-icons-path "tw.png") nil nil :ascent center)
