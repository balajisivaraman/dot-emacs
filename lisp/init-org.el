...
(use-package org
  ...
  (setq
   ...
   org-agenda-prefix-format '((agenda . "  %i   %-18c %-5s  %-8(bs/format-entry-scheduled-deadline-time)")
                              (todo . "  %i   %-18c ")
                              (tags . "  %i   %-18c ")
                              (search . "  %i   %-18c "))
   org-agenda-category-icon-alist `(("Personal Finance" ,(s-concat bs/org-agenda-icons-path "ledger.png") nil nil :ascent center)
                                    ("Routines" ,(s-concat bs/org-agenda-icons-path "habit.png") nil nil :ascent center)
                                    ("Health" ,(s-concat bs/org-agenda-icons-path "health.png") nil nil :ascent center)
                                    ("Inbox" ,(s-concat bs/org-agenda-icons-path "inbox.png") nil nil :ascent center)
                                    ("Family" ,(s-concat bs/org-agenda-icons-path "family.png") nil nil :ascent center)
                                    ("Lumos" ,(s-concat bs/org-agenda-icons-path "tw.png") nil nil :ascent center)
                                    ("Thoughtworks" ,(s-concat bs/org-agenda-icons-path "tw.png") nil nil :ascent center)
                                    ("CostaFeedback" ,(s-concat bs/org-agenda-icons-path "tw.png") nil nil :ascent center)
                                    ("Toolkit" ,(s-concat bs/org-agenda-icons-path "tw.png") nil nil :ascent center)))
